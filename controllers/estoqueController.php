...
if(isset($_GET['sucesso'])){
    $_GET['sucesso'] == 1 ? array_push($mensagens, "<h6 class=\"green-text text-darken-3\">Produto Excluido com Sucesso!!</h6>") : array_push($mensagens, "<h6 class=\"red-text text-darken-3\">Erro ao Excluir!!</h6>");
}
